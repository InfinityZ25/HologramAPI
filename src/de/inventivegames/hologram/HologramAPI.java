...
public abstract class HologramAPI {
	 ...
	 * @return <code>true</code> if a hologram was found and has been removed,
	...
	protected static int getVersion(Player p) {
		try {
			if (useProtocolSupport) {
				...
				if (name == null) {
					// System.err.println("Invalid server version! Unable to find proper
					// channel-field in getVersion.");
					return 99;
				}
